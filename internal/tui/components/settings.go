	...
	return []settingTab{
		...
		},
		{
			...
			fields: []*settingField{
				...
				keybindField("Next Session Color", "Cycle the selected session to the next color.", func(c config.Config) config.KeyBinding { return c.Keybindings.SessionColorNext }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.SessionColorNext = v }),
				keybindField("Previous Session Color", "Cycle the selected session to the previous color.", func(c config.Config) config.KeyBinding { return c.Keybindings.SessionColorPrev }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.SessionColorPrev = v }),
				keybindField("Collapse Item", "Collapse the selected item (move cursor to parent).", func(c config.Config) config.KeyBinding { return c.Keybindings.CollapseItem }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.CollapseItem = v }),
				keybindField("Expand Item", "Expand the selected collapsed item.", func(c config.Config) config.KeyBinding { return c.Keybindings.ExpandItem }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.ExpandItem = v }),
				keybindField("Sidebar View", "Switch to sidebar view.", func(c config.Config) config.KeyBinding { return c.Keybindings.SidebarView }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.SidebarView = v }),
				keybindField("Cursor Up", "Move cursor up (sidebar and grid).", func(c config.Config) config.KeyBinding { return c.Keybindings.CursorUp }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.CursorUp = v }),
				keybindField("Cursor Down", "Move cursor down (sidebar and grid).", func(c config.Config) config.KeyBinding { return c.Keybindings.CursorDown }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.CursorDown = v }),
				keybindField("Cursor Left", "Move cursor left (grid).", func(c config.Config) config.KeyBinding { return c.Keybindings.CursorLeft }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.CursorLeft = v }),
				keybindField("Cursor Right", "Move cursor right (grid).", func(c config.Config) config.KeyBinding { return c.Keybindings.CursorRight }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.CursorRight = v }),
				keybindField("Move Up", "Reorder the selected item up.", func(c config.Config) config.KeyBinding { return c.Keybindings.MoveUp }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.MoveUp = v }),
				keybindField("Move Down", "Reorder the selected item down.", func(c config.Config) config.KeyBinding { return c.Keybindings.MoveDown }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.MoveDown = v }),
				keybindField("Move Left", "Reorder the selected item left (grid).", func(c config.Config) config.KeyBinding { return c.Keybindings.MoveLeft }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.MoveLeft = v }),
				keybindField("Move Right", "Reorder the selected item right (grid).", func(c config.Config) config.KeyBinding { return c.Keybindings.MoveRight }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.MoveRight = v }),
				keybindField("Input Mode", "Enter input mode for the focused grid cell.", func(c config.Config) config.KeyBinding { return c.Keybindings.InputMode }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.InputMode = v }),
				keybindField("Detach", "Exit input mode / detach from session.", func(c config.Config) config.KeyBinding { return c.Keybindings.Detach }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.Detach = v }),
				keybindField("Toggle All Grid", "Switch between project and all-projects grid.", func(c config.Config) config.KeyBinding { return c.Keybindings.ToggleAll }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.ToggleAll = v }),
			},
		},
	}
}
