	...
	return []settingTab{
		...
		},
		{
			...
			fields: []*settingField{
				...
				keybindField("Prev Session Color", "Cycle the selected session to the previous color.", func(c config.Config) config.KeyBinding { return c.Keybindings.SessionColorPrev }, func(c *config.Config, v config.KeyBinding) { c.Keybindings.SessionColorPrev = v }),
