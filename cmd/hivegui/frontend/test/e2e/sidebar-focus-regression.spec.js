...
test.describe('#208 sidebar toggle preserves typing focus', () => {
  test('R3: window resize then ⌘S off+on re-asserts keyboard focus on the active tile', async ({
    page,
  }) => {
  ...
  test('R3: ⌘S triggers the unified toggleSidebar path (not the inline class flip)', async ({
    page,
  }) => {
