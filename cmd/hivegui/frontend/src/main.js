...
import { renderSidebar, updateSidebarSelection, initSidebar } from './app/sidebar.js';
import { onSessionBell, clearAttention, wireDaemonEvents } from './app/events.js';
import { isDaemonRestarting, initBanners } from './app/banners.js';
import {
  showSingle, switchTo, switchToProject, updateAppTitle, renderGrid,
  gridSpatialMove, shiftActiveProject, gridScopeSessions, minimizeSession,
  restoreSession, renderMinimizedTray, renderEmptyState, setView, initView,
} from './app/view.js';
import {
