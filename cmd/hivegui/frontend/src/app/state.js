...
export const state = {
  ...
  attentionReturnId: null,  // session to jump back to (⇧⌘B) after ⌘B took
                            //   you to a flagged session. Written only when
                            //   empty, so a tour of several flagged sessions
                            //   keeps the original anchor; cleared on use.
