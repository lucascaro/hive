...
| P2 | — | Strip ANSI escape sequences from update build progress lines | REVIEW | [253-strip-ansi-escapes-from-update-progress](253-strip-ansi-escapes-from-update-progress.md) |
